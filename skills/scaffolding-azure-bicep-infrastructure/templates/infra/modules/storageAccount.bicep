// CANONICAL SOURCE: skills/optimizing-azure-blob-storage-cost/templates/storageAccount-with-lifecycle.bicep
// Verbatim copy so the scaffold compiles standalone. Edit the canonical file, then re-copy here.
